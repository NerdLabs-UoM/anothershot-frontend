...
export function NotificationCard({
  ...
  const getLinkHref = () => {
    switch (type) {
      case "signIn":
        return "/sign-in";
      case ("bookingC"|| "bookingP"):
        return `/user/photographer/${receiverId}/bookings`;
      case "feedback":
        return `/user/photographer/${receiverId}/profile`
      default:
        return "#";
    }
  };
        ...
        <CardContent className="relative ">
          <div className="static grid grid grid-col-2 grid-flow-col ">
            <div className="flex flex-col">
              ...
              <div className="text-xs absolute right-2 sm:bottom-2 bottom-8 ">
