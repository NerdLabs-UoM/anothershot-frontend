...
export const PackageCard = ({src , alt ,width ,height ,name , description , price }:CardProps) => {
  return (
    <div className="mt-2 mb-0 px-6 ">
      <div className=" w-96 grid-rows-2 sm:grid-rows-2 sm:grid-cols-1 mt-0  ">
