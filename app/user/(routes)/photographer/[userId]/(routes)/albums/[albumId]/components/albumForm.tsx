...
const albumFormSchema = z.object({
  ...
  visibile: z.boolean().default(false).optional(),
      ...
      <DialogTrigger>
        {isPhotographer &&
          (isCreateAlbum ? (
            ...
            <Pencil color="black" size={15} className="mt-2" />
          ))}
      </DialogTrigger>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>
            {isCreateAlbum ? "Create Album" : "Edit Album"}
          </DialogTitle>
          <DialogDescription>
            {isCreateAlbum
          ...
          >
              ...
              render={({ field }) => (
                <FormItem>
                  <div className="grid items-center grid-cols-4 gap-4">
                    <FormLabel className="text-right">Album Name</FormLabel>
                    <FormControl>
                      <Input
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <div className="grid items-center grid-cols-4 gap-4">
                    <FormLabel className="text-right">Price (USD)</FormLabel>
                    <FormControl>
                      <Input
            ...
            <DialogFooter>
              <Button type="submit">
                {isCreateAlbum ? "Create Album" : "Save"}
              </Button>
            </DialogFooter>
          </form>
        </Form>
