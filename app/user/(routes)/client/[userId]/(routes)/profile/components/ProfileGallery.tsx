...
const ProfileGallery = () => {
  ...
  return (
    <Tabs defaultValue="like" className="flex flex-col items-center w-11/12 lg:w-2/3">
      ...
      <TabsContent value="save" className="lg:w-2/3 w-auto min-w-full h-screen">
        {isLoadingSaved ? (
          ...
          <ScrollArea className="h-5/6 lg:h-4/5 p-4">
            <div className="grid grid-cols-3 2xl:grid-cols-4 gap-2 sm:gap-4">
